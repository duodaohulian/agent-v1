"""Register the independent pathology feature tool."""
...
from crc_lnm_mcp.contracts.pathology_features import PreparePathologyInput
...
def register(mcp: Any, runtime: RuntimeProvider) -> None:
    async def tool(
        ...
        data = runtime.cases.prepare_pathology_features(
            case_ref,
        ...
        return {
            ...
            "status": {
                "code": 2000,
                "name": "OK",
                "message": "Pathology features prepared.",
                "severity": "info",
                "retryable": False,
            },
            "data": data,
