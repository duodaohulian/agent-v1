...
def _default_command() -> str:
    names = ["crc-lnm-medical-agent-twomeme-17"]
    if sys.platform == "win32":
        names.append("crc-lnm-medical-agent-twomeme-17.exe")
    for name in names:
    ...
    filename = "crc-lnm-medical-agent-twomeme-17.exe" if sys.platform == "win32" else names[0]
